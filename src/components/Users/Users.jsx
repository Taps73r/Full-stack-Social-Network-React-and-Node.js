    ...
    <>
      <div className="find_user">
        <div className="find_user_border">
          <textarea
            onChange={updateFindText}
            value={props.newUserSearchText}
            placeholder="Find..."
          ></textarea>
          <button onClick={props.onSearchClick} className="find_btn">
      ...
      <div>
              ...
              <div className="user_area">
                <div className="avatar_button">
                  <NavLink to={"/user-profile/" + u.userId}>
                    <img
                      src={u.photo != null ? u.photo : staticPhoto}
                      alt="User-Avatar"
                    />
                  </NavLink>
                </div>
                <div className="users_info">
                  <div className="users_name">
                    ...
                    <button
                      onClick={() =>
                        props.handleSubscribe(loggedInUserId, u.userId)
                      }
                    >
                      {u.followers.includes(loggedInUserId)
                        ? "Unfollow"
                        : "Follow"}
                    </button>
                  </div>
                  <p className="users_bio">
        ...
        <div className="pagination">
          {pages.map((p, index) => (
            <div
              key={index}
              id={props.currentPage === p ? "selectedPage" : ""}
